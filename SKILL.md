...
description: High-coverage Russian visual rebus solver for Hermes Agent. Handles classic picture-letter rebuses, spatial constructions, Planet Rebus conventions, logopedic and musical puzzles, thematic puzzles, and phrase-level phonetic/meta rebuses based on presence/absence/crossing/missing-sequence states.
version: 2.1.0
author: Custom skill
license: MIT
